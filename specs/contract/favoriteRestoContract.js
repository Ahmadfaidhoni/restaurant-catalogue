const itActsAsfavoriteRestoModel = (favoriteResto) => {
  ...
  it('should be able to search for restos', async () => {
    favoriteResto.putResto({ id: 1, title: 'restaurant a' });
    favoriteResto.putResto({ id: 2, title: 'restaurant b' });
    favoriteResto.putResto({ id: 3, title: 'restaurant abc' });
    favoriteResto.putResto({ id: 4, title: 'ini mah restaurant abcd' });
